INSERT INTO tipos_infraccion (codigo, descripcion, monto_base) VALUES
...
INSERT INTO infractores (dni, nombre, apellido, email, bloqueado) VALUES
...
INSERT INTO vehiculos (placa, marca, anio, suspendido) VALUES
                                                           ('ABC-123', 'Toyota', 2020, false),
                                                           ('DEF-456', 'Honda', 2019, false),
                                                           ('GHI-789', 'Nissan', 2021, false);

INSERT INTO infractor_vehiculo (infractor_id, vehiculo_id) VALUES
                                                               (1, 1),
                                                               (1, 2),
                                                               (2, 2),
                                                               (3, 3);